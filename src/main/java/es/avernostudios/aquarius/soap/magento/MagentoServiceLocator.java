...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements es.avernostudios.aquarius.soap.magento.MagentoService {
    ...
    private java.lang.String Mage_Api_Model_Server_V2_HandlerPort_address = "http://www.latiendadeabc.com/index.php/api/v2_soap/index/";
    ...
    public es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort() throws javax.xml.rpc.ServiceException {
    ...
    public es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new es.avernostudios.aquarius.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_V2_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_V2_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
