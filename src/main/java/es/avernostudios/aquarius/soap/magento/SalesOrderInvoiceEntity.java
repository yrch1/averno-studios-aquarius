...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceItemEntity[] items;

    private es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceItemEntity[] items,
           es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(es.avernostudios.aquarius.soap.magento.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
