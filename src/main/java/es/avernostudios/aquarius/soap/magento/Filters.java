...
public class Filters  implements java.io.Serializable {
    private es.avernostudios.aquarius.soap.magento.AssociativeEntity[] filter;

    private es.avernostudios.aquarius.soap.magento.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           es.avernostudios.aquarius.soap.magento.AssociativeEntity[] filter,
           es.avernostudios.aquarius.soap.magento.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public es.avernostudios.aquarius.soap.magento.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(es.avernostudios.aquarius.soap.magento.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public es.avernostudios.aquarius.soap.magento.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(es.avernostudios.aquarius.soap.magento.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
