...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private es.avernostudios.aquarius.soap.magento.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           es.avernostudios.aquarius.soap.magento.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public es.avernostudios.aquarius.soap.magento.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(es.avernostudios.aquarius.soap.magento.CatalogProductImageFileEntity file) {
        this.file = file;
    }
