...
public class ApiEntity  implements java.io.Serializable {
    ...
    private es.avernostudios.aquarius.soap.magento.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           es.avernostudios.aquarius.soap.magento.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public es.avernostudios.aquarius.soap.magento.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(es.avernostudios.aquarius.soap.magento.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
