...
public class CatalogProductCreateEntity  implements java.io.Serializable {
    ...
    private es.avernostudios.aquarius.soap.magento.AssociativeEntity[] additional_attributes;

    private es.avernostudios.aquarius.soap.magento.CatalogInventoryStockItemUpdateEntity stock_data;
    ...
    public CatalogProductCreateEntity(
           ...
           es.avernostudios.aquarius.soap.magento.AssociativeEntity[] additional_attributes,
           es.avernostudios.aquarius.soap.magento.CatalogInventoryStockItemUpdateEntity stock_data) {
     ...
     */
    public es.avernostudios.aquarius.soap.magento.AssociativeEntity[] getAdditional_attributes() {
        return additional_attributes;
    }
     ...
     */
    public void setAdditional_attributes(es.avernostudios.aquarius.soap.magento.AssociativeEntity[] additional_attributes) {
        this.additional_attributes = additional_attributes;
    }
     ...
     * @return stock_data
     */
    public es.avernostudios.aquarius.soap.magento.CatalogInventoryStockItemUpdateEntity getStock_data() {
        return stock_data;
    }
     ...
     * @param stock_data
     */
    public void setStock_data(es.avernostudios.aquarius.soap.magento.CatalogInventoryStockItemUpdateEntity stock_data) {
        this.stock_data = stock_data;
    }
