...
public class CatalogCategoryEntity  implements java.io.Serializable {
    ...
    private es.avernostudios.aquarius.soap.magento.CatalogCategoryEntity[] children;
    ...
    public CatalogCategoryEntity(
           ...
           int position,
           int level,
           es.avernostudios.aquarius.soap.magento.CatalogCategoryEntity[] children) {
     ...
     * @return children
     */
    public es.avernostudios.aquarius.soap.magento.CatalogCategoryEntity[] getChildren() {
        return children;
    }
     ...
     * @param children
     */
    public void setChildren(es.avernostudios.aquarius.soap.magento.CatalogCategoryEntity[] children) {
        this.children = children;
    }
