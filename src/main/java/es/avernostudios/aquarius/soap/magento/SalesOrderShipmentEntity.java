...
public class SalesOrderShipmentEntity  implements java.io.Serializable {
    ...
    private es.avernostudios.aquarius.soap.magento.SalesOrderShipmentItemEntity[] items;

    private es.avernostudios.aquarius.soap.magento.SalesOrderShipmentTrackEntity[] tracks;

    private es.avernostudios.aquarius.soap.magento.SalesOrderShipmentCommentEntity[] comments;
    ...
    public SalesOrderShipmentEntity(
           ...
           es.avernostudios.aquarius.soap.magento.SalesOrderShipmentItemEntity[] items,
           es.avernostudios.aquarius.soap.magento.SalesOrderShipmentTrackEntity[] tracks,
           es.avernostudios.aquarius.soap.magento.SalesOrderShipmentCommentEntity[] comments) {
     ...
     * @return items
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderShipmentItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(es.avernostudios.aquarius.soap.magento.SalesOrderShipmentItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return tracks
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderShipmentTrackEntity[] getTracks() {
        return tracks;
    }
     ...
     * @param tracks
     */
    public void setTracks(es.avernostudios.aquarius.soap.magento.SalesOrderShipmentTrackEntity[] tracks) {
        this.tracks = tracks;
    }
     ...
     * @return comments
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderShipmentCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(es.avernostudios.aquarius.soap.magento.SalesOrderShipmentCommentEntity[] comments) {
        this.comments = comments;
    }
