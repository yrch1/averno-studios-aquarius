...
public class SalesOrderEntity implements java.io.Serializable, Comparable<SalesOrderEntity> {
    ...
    private es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity shipping_address;
    private es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity billing_address;
    private es.avernostudios.aquarius.soap.magento.SalesOrderItemEntity[] items;
    private es.avernostudios.aquarius.soap.magento.SalesOrderPaymentEntity payment;
    private es.avernostudios.aquarius.soap.magento.SalesOrderStatusHistoryEntity[] status_history;
    ...
    public SalesOrderEntity(
            ...
            es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity shipping_address,
            es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity billing_address,
            es.avernostudios.aquarius.soap.magento.SalesOrderItemEntity[] items,
            es.avernostudios.aquarius.soap.magento.SalesOrderPaymentEntity payment,
            es.avernostudios.aquarius.soap.magento.SalesOrderStatusHistoryEntity[] status_history) {
     ...
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity getShipping_address() {
        return shipping_address;
    }
     ...
     */
    public void setShipping_address(es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity shipping_address) {
        this.shipping_address = shipping_address;
    }
     ...
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity getBilling_address() {
        return billing_address;
    }
     ...
     */
    public void setBilling_address(es.avernostudios.aquarius.soap.magento.SalesOrderAddressEntity billing_address) {
        this.billing_address = billing_address;
    }
     ...
     * @return items
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(es.avernostudios.aquarius.soap.magento.SalesOrderItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return payment
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderPaymentEntity getPayment() {
        return payment;
    }
     ...
     * @param payment
     */
    public void setPayment(es.avernostudios.aquarius.soap.magento.SalesOrderPaymentEntity payment) {
        this.payment = payment;
    }
     ...
     */
    public es.avernostudios.aquarius.soap.magento.SalesOrderStatusHistoryEntity[] getStatus_history() {
        return status_history;
    }
     ...
     */
    public void setStatus_history(es.avernostudios.aquarius.soap.magento.SalesOrderStatusHistoryEntity[] status_history) {
        this.status_history = status_history;
    }
     ...
     * @return
     */
    public int compareTo(SalesOrderEntity o) {
        int result = 0;
        try {
            
            SimpleDateFormat formatoDeFecha = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date fecha1 = formatoDeFecha.parse(this.getCreated_at());
            Date fecha2 = formatoDeFecha.parse(o.getCreated_at());
            ...
            org.apache.log4j.Logger.getLogger(SalesOrderEntity.class).error("Error en el parseo", ex);
        }
        return result;
    }
}
