...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements com.gruporon2005.soap.magento.MagentoService {
    ...
    public com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new com.gruporon2005.soap.magento.Mage_Api_Model_Server_V2_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_V2_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_V2_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
