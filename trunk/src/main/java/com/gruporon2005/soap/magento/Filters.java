...
public class Filters  implements java.io.Serializable {
    private com.gruporon2005.soap.magento.AssociativeEntity[] filter;

    private com.gruporon2005.soap.magento.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           com.gruporon2005.soap.magento.AssociativeEntity[] filter,
           com.gruporon2005.soap.magento.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public com.gruporon2005.soap.magento.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.gruporon2005.soap.magento.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public com.gruporon2005.soap.magento.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(com.gruporon2005.soap.magento.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
