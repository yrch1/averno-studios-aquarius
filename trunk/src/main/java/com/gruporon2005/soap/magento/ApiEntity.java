...
public class ApiEntity  implements java.io.Serializable {
    ...
    private com.gruporon2005.soap.magento.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           com.gruporon2005.soap.magento.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public com.gruporon2005.soap.magento.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(com.gruporon2005.soap.magento.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
