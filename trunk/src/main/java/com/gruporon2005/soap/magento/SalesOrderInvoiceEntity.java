...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private com.gruporon2005.soap.magento.SalesOrderInvoiceItemEntity[] items;

    private com.gruporon2005.soap.magento.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           com.gruporon2005.soap.magento.SalesOrderInvoiceItemEntity[] items,
           com.gruporon2005.soap.magento.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public com.gruporon2005.soap.magento.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.gruporon2005.soap.magento.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public com.gruporon2005.soap.magento.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(com.gruporon2005.soap.magento.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
